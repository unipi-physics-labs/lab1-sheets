...
\labsubsection{Bonus: Stima della costante di decadimento del raffreddamento}
...
opportunamente normalizzato ($N$) e traslato alla temperatura finale ($T_f$):
\begin{align}
  T(t; \lambda, T_f, N) = N e^{-\lambda t} + T_f
\end{align}
Tramite un fit dei minimi quadrati potete stimare il valore della costante di decadimento.
