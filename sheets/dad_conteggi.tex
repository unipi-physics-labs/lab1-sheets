...
\secmeasurements
L'evento che vogliamo studiare è il seguente \emph{una persona entra in un negozio}. Scegliete un negozio abbastanza frequentato (ad esempio un supermercato) e prendete le misure in due momenti diversi (due acquisizioni): uno in cui il negozio è poco frequentato, e uno in cui il negozio è più frequentato.
...
Unite adesso, le due acquisizioni e ripetete l'analisi fatta precedentemente su questo unico set di dati.
\vspace{0.5cm}
Cercate di rispondere alle seguenti domande:
\begin{enumerate}
